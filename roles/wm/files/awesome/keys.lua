...
local globalkeys = gears.table.join(
    ...
    awful.key({ }, "Print", function () awful.util.spawn_with_shell("mkdir -p ~/Pictures/scrot && scrot ~/Pictures/scrot/$(date +%F_%T).png") end,
              {description = "Take full screenshot", group = "fn keys"}),
    awful.key({ modkey, }, "Print", function () awful.util.spawn_with_shell("mkdir -p ~/Pictures/scrot && sleep 0.2 && scrot -s ~/Pictures/scrot/$(date +%F_%T).png") end,
              {description = "Take screenshot of selection", group = "fn keys"}),
